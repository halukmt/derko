...
### Changed
- **Address anonymization**: Replaced full street addresses with `"Duisburg Süd, <country>"` in all 9 language files for all 7 apartments. Original addresses are preserved in `"city_original"` fields and can be restored at any time.
